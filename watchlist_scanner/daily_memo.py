...
# ---------------------------------------------------------------------------
# Re-exports from the split-out memo package (2026-08-07)
# ---------------------------------------------------------------------------
# daily_memo remains the single public import surface: every existing
# `from watchlist_scanner.daily_memo import X` keeps resolving, including the
# private helpers two test modules import directly. The primitives are defined
# once in memo._shared so the extracted modules can use them without importing
# their former home, which would be circular.
from watchlist_scanner.memo._shared import (  # noqa: E402,F401
...
from watchlist_scanner.memo.discovery import (  # noqa: E402,F401
